...
$relpfad = JURI::base(true) . '/' . 'components' . '/' . $CTOPluginName;
...
ob_start();
?>
<form method="post" name="form" id="huffman-form">
    <table border=0>
	<tr>
	    <td>
		...
		<br />
		<input type=submit class="ctoformcss-default-button-m" id="huffman-submit" value="<?php echo $lang_encode?>" />
	    </td>
	</tr>
    </table>
...
<div id="huffman-data">
    <br />
    <?php echo $lang_huffmancodedtext?>:<br />
    <textarea name=codtxt class="ctoformcss-txtoutput-style ctoformcss-default-input-size" readonly><?php echo $codtxt?></textarea>
    <p>
...
?>
    <tr>
	<td>
	    <b>&nbsp;<?php echo $lang_number?>&nbsp;</b>
	</td>
	<td>
	    <b>&nbsp;<?php echo $lang_sign?>&nbsp;</b>
	</td>
	<td>
	    <b>&nbsp;ASCII&nbsp;</b>
	</td>
	<td>
	    <b>&nbsp;<?php echo $lang_frequency?>&nbsp;</b>
	</td>
	<td>
	    <b>&nbsp;Huffman&nbsp;</b>
	</td>
...
ob_end_clean();
if(!JRequest::getVar('ajax', false, 'default', 'boolean'))
    echo $form;
