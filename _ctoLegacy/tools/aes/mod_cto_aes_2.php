...
$CTOStylesheetname="style.css";

//Do you need a warning if JavaScript is disabled?
$CTOJavaScriptWarning=TRUE;
...
$doc->addCustomTag('<script type="text/javascript" src="'.$mypath.'aes.js"></script>');
$doc->addCustomTag('<script type="text/javascript" src="'.$mypath.'entropy.js"></script>');
$doc->addCustomTag('<script type="text/javascript" src="'.$mypath.'aesprng.js"></script>');
$doc->addCustomTag('<script type="text/javascript" src="'.$mypath.'lecuyer.js"></script>');
$doc->addCustomTag('<script type="text/javascript" src="'.$mypath.'md5.js"></script>');
$doc->addCustomTag('<script type="text/javascript" src="'.$mypath.'armour.js"></script>');
$doc->addCustomTag('<script type="text/javascript" src="'.$mypath.'utf-8.js"></script>');
//$doc->addCustomTag('<script type="text/javascript" src="'.$mypath.'jscrypt.js"></script>');
$doc->addCustomTag('<script type="text/javascript" src="'.$mypath.$CTOJSname.'"></script>');
