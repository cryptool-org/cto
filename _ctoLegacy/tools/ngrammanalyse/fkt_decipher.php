...
$lang_gramm1=JTEXT::_('1GRAMM');
$lang_gramm2=JTEXT::_('2GRAMM');
$lang_gramm3=JTEXT::_('3GRAMM');
$lang_gramm4=JTEXT::_('4GRAMM');
    ...
    if ( is_array($mo) )
    {
        $text.= '<td width=150 colspan=3 align=center><b>'.$lang_gramm1.'</td>';
    }
    if ( is_array($bi) )
    {
        $text.= '<td width=150 colspan=3 align=center><b>'.$lang_gramm2.'</td>';
    }
    if ( is_array($tr) )
    {
        $text.= '<td width=150 colspan=3 align=center><b>'.$lang_gramm3.'</td>';
    }
    if ( is_array($qu) )
    {
        $text.= '<td width=150 colspan=3 align=center><b>'.$lang_gramm4.'</td>';
    }
    $text.= '</tr>';
