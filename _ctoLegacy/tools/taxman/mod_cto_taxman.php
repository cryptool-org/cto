...
//Module-Author
$CTOAuthor="Christian Sieche, Original Taxman Game: <a href='http://davidbau.com/archives/2008/12/07/taxman_game.html' target='_blank'>David Bau</a>";

//Module-Name
//For example: mod_cto_caesar
//Your folder has to be equal to the module name!
$CTOModuleName="mod_cto_taxman";
