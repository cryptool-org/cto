...
function Huffman() {
    ...
    this.build_table = function(input, huff_code) {
        ...
        return '<table border="0"><tbody><tr><td><h2>RESULT</h2><br><b>' +
            'STORAGESIZE:</b><blockquote>' +
            'ASCII: ' + ((input.length) * 8).toString() + ' bit<br>' +
            'Huffman: ' + (huff_code.length).toString() + 'bit<br></blockquote><b>' +
            'ENTROPY:</b><blockquote>' +
            'ASCII: ' + entropy_huff.toString() +'<br>' +
            'Huffman: ' + entropy_huff.toString() +'<br></blockquote><b>' +
            'CODELENGTH:</b><blockquote>' +
            'ASCII: ' + ascii_length.toString() + ' bit<br>' +
            'Huffman: ' + huff_length.toString() + ' bit<br></blockquote><b>' +
            'COMPRESSION:</b> ' + (huff_length/8).toString() + '<br><br>' +
            '<table cellspacing="0" cellpadding="4" border="1"><tbody><tr><td><b>&nbsp;NUMBER&nbsp;</b></td><td><b>&nbsp;SIGN&nbsp;</b></td><td><b>&nbsp;ASCII&nbsp;</b></td><td><b>&nbsp;FREQUENCY&nbsp;</b></td><td><b>&nbsp;Huffman&nbsp;</b></td><td><b>&nbsp;ASCII&nbsp;</b></td></tr>' +
            table_body +
