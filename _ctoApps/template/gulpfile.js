...
gulp.task('default', [ 'bootstrap', 'jquery', 'html', 'js', 'css', 'config' ]);

function dirs_to_deploy() {
    return gulp.src(['dist/*', '!dist/locales', '!dist/bootstrap*', '!dist/jquery*']);
}

function files_to_deploy() {
    return gulp.src(['dist/**', '!dist/locales', '!dist/locales/**', '!dist/*/web-*.html', '!dist/bootstrap*', '!dist/jquery*']);
}
